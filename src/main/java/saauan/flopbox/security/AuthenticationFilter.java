...
/**
 * The token authentication filter is responsible to get the authentication filter from the header and call the authentication manager for authentication
 */
